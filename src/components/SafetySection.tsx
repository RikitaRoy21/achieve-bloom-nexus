...
export const SafetySection = () => {
  return (
    <section id="safety" className="py-24 bg-gradient-to-br from-success/10 to-accent/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="dashboard-card safety-gradient text-white p-8">
              ...
              <div className="space-y-4">
                <Button 
                  size="lg" 
                  className="w-full bg-white text-success hover:bg-white/90 font-semibold"
                >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-6 rounded-xl bg-card border border-success/20">
          ...
          <div className="text-center p-6 rounded-xl bg-card border border-success/20">
            ...
            <div className="text-muted-foreground">Certified Security</div>
          </div>
        </div>
      </div>
    </section>
